            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="info-product mt-5">
                        <div class="row m-4">Name</div>
                        <div class="row m-4">Price</div>
                        <div class="row m-5">
                            Description
                            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quasi, eaque cupiditate consectetur incidunt ab, doloremque molestias, dicta voluptatibus quibusdam unde qui laboriosam doloribus ea deserunt? Nulla tempore nostrum voluptatibus iure!
                        </div>
