...
<div class="container">
    ...
    <div class="main">
        <div class="topbar">
            ...
            <div class="user">
                <img src="admin/styles/assets/imgs/customer01.jpg" alt="">
            </div>
        </div>
        ...
        <div class="chart">
            ...
            <div class="chartContainer">
                <h2>Revenue Percentage Over Time</h2>
        ...
        <div class="details">
            ...
            <div class="recentCustomers">
                ...
                <table>
                    <tr>
                        <td width="60px">
                            <div class="imgBx"><img src="admin/styles/assets/imgs/customer02.jpg" alt=""></div>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td width="60px">
                            <div class="imgBx"><img src="admin/styles/assets/imgs/customer01.jpg" alt=""></div>
                        </td>
                        <td>
