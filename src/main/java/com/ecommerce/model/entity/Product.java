...
@NamedQueries({ @NamedQuery(name = "Product.findAll", query = "SELECT p FROM Product p"),
        ...
        @NamedQuery(name = "Product.findByCategoryAndNewest", query = "SELECT p FROM Product p JOIN Category c ON p.idCategory = c.id AND c.id = :categoryId ORDER BY p.postDate DESC "),
